class OrderItem
  ...
  with_options presence: true do
    ...
    def save
      ...
      Address.create(postcode: postcode, prefecture_id: prefectures_id, municipality: municipality, address: address, building: building, phone_number: phone_number, order_id: order.id)
    end
end